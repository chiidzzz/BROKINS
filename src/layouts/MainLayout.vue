  ...
  data() {
    return {
      ...
      menus: [
        ...
        { title: "Policies", link_name: "policies" },
        { title: "Reports", link_name: "reports" },
        {
          title: "Settings",
          dropdown: true,
          submenus: [
            { title: "Policies Types", link_name: "policy-types" },
            { title: "Policies Categories", link_name: "policy-categories" },
            { title: "Insurance Providers", link_name: "insurance-providers" },
            ...
            { title: "Brokers", link_name: "brokers" },
          ],
        },
      ],
